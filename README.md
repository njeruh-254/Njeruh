...
/* Artwork Icon/Image Transitions */
.artwork {
...
/* Feature Card Icon Transitions (if you have feature cards) */
.feature-card {
    transition: all 0.3s ease;
}
...
/* Add this to make icons bounce on page load */
.service-card:hover .service-icon {
